...
function updateGuidesSection() {
  guidesContainer.innerHTML = `
    <div class="guide-item">
      ...
      <button class="btn-book" data-guide="Bikash Gurung" data-price="$65/day">
    ...
    <div class="guide-item">
      ...
      <button class="btn">View Profile</button>
      <button class="btn-book" data-guide="Maya Thapa" data-price="$55/day">
        <i class="fas fa-calendar-check"></i> Book Now
      </button>
    </div>
    <div class="guide-item">
      ...
      <button class="btn">View Profile</button>
      <button class="btn-book" data-guide="Rajesh Bhandari" data-price="$75/day">
        <i class="fas fa-calendar-check"></i> Book Now
      </button>
    </div>
    <div class="guide-item">
      ...
      <button class="btn">View Profile</button>
      <button class="btn-book" data-guide="Sunita Rai" data-price="$50/day">
        <i class="fas fa-calendar-check"></i> Book Now
      </button>
    </div>
    <div class="guide-item">
      ...
      <button class="btn">View Profile</button>
      <button class="btn-book" data-guide="Pemba Sherpa" data-price="$95/day">
        <i class="fas fa-calendar-check"></i> Book Now
      </button>
    </div>
  `;
